[light_cnt_x,light_cnt_y] = textread('081730109.txt','%n%n');
[loss_x,loss_y] = textread('081730109_loss.txt','%n%n');
[afterLoss_x,afterLoss_y] = textread('081730109_afterLoss.txt','%n%n');
