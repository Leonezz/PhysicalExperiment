...
%data here,all vectors should be column vectors.
z_1 = zeros(8,1);
z_1(1) = 90;
for i=2:8
    z_1(i) = z_1(i-1)-4;
...
%z_1 = [];
omega_x = [482.414;414.742;318.635;270.412;271.265;325.443;382.802;434.076]/2;
omega_y = [538.36;456.679;336.012;278.8;299.791;346.585;404.272;462.416]/2;
